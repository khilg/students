...
public class StudentUtil {
	...
	public static Student findByUuid_First(
		...
		throws com.docs.assignment.student.exception.NoSuchStudentException {
	...
	/**
	 * Returns all the students where email = &#63;.
	 *
	 * @param email the email
	 * @return the matching students
	 */
	public static List<Student> findByEmail(String email) {
		return getPersistence().findByEmail(email);
	}

	/**
	 * Returns a range of all the students where email = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StudentModelImpl</code>.
	 * </p>
	 ...
	 * @return the range of matching students
	 */
	public static List<Student> findByEmail(String email, int start, int end) {
		return getPersistence().findByEmail(email, start, end);
	}

	/**
	 * Returns an ordered range of all the students where email = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StudentModelImpl</code>.
	 * </p>
	 ...
	 * @return the ordered range of matching students
	 */
	public static List<Student> findByEmail(
	...
	/**
	 * Returns the first student in the ordered set where email = &#63;.
	 *
	 * @param email the email
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching student
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByEmail_First(
			String email, OrderByComparator<Student> orderByComparator)
		throws com.docs.assignment.student.exception.NoSuchStudentException {
	 ...
	 * @return the first matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByEmail_First(
		String email, OrderByComparator<Student> orderByComparator) {
	...
	/**
	 * Returns the last student in the ordered set where email = &#63;.
	 *
	 * @param email the email
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching student
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByEmail_Last(
			String email, OrderByComparator<Student> orderByComparator)
		throws com.docs.assignment.student.exception.NoSuchStudentException {
	 ...
	 * @return the last matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByEmail_Last(
		String email, OrderByComparator<Student> orderByComparator) {
	...
	/**
	 * Returns the students before and after the current student in the ordered set where email = &#63;.
	 *
	 * @param studentId the primary key of the current student
	 * @param email the email
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public static Student[] findByEmail_PrevAndNext(
			long studentId, String email,
			OrderByComparator<Student> orderByComparator)
		throws com.docs.assignment.student.exception.NoSuchStudentException {

		return getPersistence().findByEmail_PrevAndNext(
			studentId, email, orderByComparator);
	}

	/**
	 * Removes all the students where email = &#63; from the database.
	 *
	 * @param email the email
	 */
	...
	/**
	 * Returns the number of students where email = &#63;.
	 *
	 * @param email the email
	 * @return the number of matching students
	 */
