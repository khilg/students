...
import com.docs.assignment.student.exception.NoSuchStudentException;
...
public interface StudentPersistence extends BasePersistence<Student> {
	 ...
	 * @return the matching students
	 */
	public java.util.List<Student> findByEmail(String email);
	 ...
	 * @return the range of matching students
	 */
	public java.util.List<Student> findByEmail(
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public Student findByEmail_First(
			String email,
			com.liferay.portal.kernel.util.OrderByComparator<Student>
				orderByComparator)
		throws NoSuchStudentException;
	 ...
	 * @return the first matching student, or <code>null</code> if a matching student could not be found
	 */
	public Student fetchByEmail_First(
		String email,
		com.liferay.portal.kernel.util.OrderByComparator<Student>
			orderByComparator);
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public Student findByEmail_Last(
			String email,
			com.liferay.portal.kernel.util.OrderByComparator<Student>
				orderByComparator)
		throws NoSuchStudentException;
	 ...
	 * @return the last matching student, or <code>null</code> if a matching student could not be found
	 */
	public Student fetchByEmail_Last(
		String email,
		com.liferay.portal.kernel.util.OrderByComparator<Student>
			orderByComparator);
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public Student[] findByEmail_PrevAndNext(
