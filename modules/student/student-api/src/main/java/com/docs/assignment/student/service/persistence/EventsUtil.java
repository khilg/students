...
package com.docs.assignment.student.service.persistence;
...
public class EventsUtil {
	 ...
	 */
	public static Map<Serializable, Events> fetchByPrimaryKeys(
	 ...
	 */
	public static List<Events> findWithDynamicQuery(
	 ...
	 */
	public static List<Events> findByUuid(String uuid) {
	 ...
	 */
	public static List<Events> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<Events> findByUuid(
	 ...
	 */
	public static Events findByUuid_First(
			String uuid, OrderByComparator<Events> orderByComparator)
		throws com.docs.assignment.student.exception.NoSuchEventsException {
	 ...
	 */
	public static Events fetchByUuid_First(
		String uuid, OrderByComparator<Events> orderByComparator) {
	 ...
	 * @throws NoSuchEventsException if a matching events could not be found
	 */
	public static Events findByUuid_Last(
			String uuid, OrderByComparator<Events> orderByComparator)
		throws com.docs.assignment.student.exception.NoSuchEventsException {
	 ...
	 */
	public static Events fetchByUuid_Last(
		String uuid, OrderByComparator<Events> orderByComparator) {
	 ...
	 */
	public static Events[] findByUuid_PrevAndNext(
	 ...
	 * @throws NoSuchEventsException if a matching events could not be found
	 */
	public static Events findByUUID_G(String uuid, long groupId)
		throws com.docs.assignment.student.exception.NoSuchEventsException {
	 ...
	 */
	public static Events fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching events, or <code>null</code> if a matching events could not be found
	 */
	public static Events fetchByUUID_G(
	 ...
	 */
	public static Events removeByUUID_G(String uuid, long groupId)
		throws com.docs.assignment.student.exception.NoSuchEventsException {
	 ...
	 * @return the matching eventses
	 */
	public static List<Events> findByUuid_C(String uuid, long companyId) {
	 ...
	 * @return the range of matching eventses
	 */
	public static List<Events> findByUuid_C(
	 ...
	 * @throws NoSuchEventsException if a matching events could not be found
	 */
	public static Events findByUuid_C_First(
	 ...
	 * @return the first matching events, or <code>null</code> if a matching events could not be found
	 */
	public static Events fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<Events> orderByComparator) {
	 ...
	 * @throws NoSuchEventsException if a matching events could not be found
	 */
	public static Events findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<Events> orderByComparator)
		throws com.docs.assignment.student.exception.NoSuchEventsException {
	 ...
	 * @return the last matching events, or <code>null</code> if a matching events could not be found
	 */
	public static Events fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<Events> orderByComparator) {
	 ...
	 * @throws NoSuchEventsException if a events with the primary key could not be found
	 */
	public static Events[] findByUuid_C_PrevAndNext(
	 ...
	 * @return the matching eventses
	 */
	public static List<Events> findByGroupId(long groupId) {
	 ...
	 * @return the range of matching eventses
	 */
	public static List<Events> findByGroupId(long groupId, int start, int end) {
	 ...
	 * @return the ordered range of matching eventses
	 */
	public static List<Events> findByGroupId(
	 ...
	 * @throws NoSuchEventsException if a matching events could not be found
	 */
	public static Events findByGroupId_First(
	 ...
	 * @return the first matching events, or <code>null</code> if a matching events could not be found
	 */
	public static Events fetchByGroupId_First(
		long groupId, OrderByComparator<Events> orderByComparator) {
	 ...
	 * @throws NoSuchEventsException if a matching events could not be found
	 */
	public static Events findByGroupId_Last(
			long groupId, OrderByComparator<Events> orderByComparator)
		throws com.docs.assignment.student.exception.NoSuchEventsException {
	 ...
	 * @return the last matching events, or <code>null</code> if a matching events could not be found
	 */
	public static Events fetchByGroupId_Last(
		long groupId, OrderByComparator<Events> orderByComparator) {
	 ...
	 * @throws NoSuchEventsException if a events with the primary key could not be found
	 */
	public static Events[] findByGroupId_PrevAndNext(
	...
	private static ServiceTracker<EventsPersistence, EventsPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(EventsPersistence.class);

		ServiceTracker<EventsPersistence, EventsPersistence> serviceTracker =
			new ServiceTracker<EventsPersistence, EventsPersistence>(
				bundle.getBundleContext(), EventsPersistence.class, null);
