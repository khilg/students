...
/**
 * This class is used by SOAP remote services, specifically {@link com.docs.assignment.student.service.http.StudentServiceSoap}.
 *
...
public class StudentSoap implements Serializable {
	...
	public static StudentSoap toSoapModel(Student model) {
		...
		soapModel.setAssignment_status(model.getAssignment_status());
