...
import com.docs.assignment.student.model.impl.StudentModelImpl;
...
public class StudentPersistenceImpl
	 ...
	 */
	@Override
	public List<Student> findByEmail(String email, int start, int end) {
	...
	public Student findByEmail_First(
		...
		Student student = fetchByEmail_First(email, orderByComparator);
	...
	public Student fetchByEmail_First(
		...
		List<Student> list = findByEmail(email, 0, 1, orderByComparator);
	...
	public Student findByEmail_Last(
		...
		Student student = fetchByEmail_Last(email, orderByComparator);
	...
	public Student[] findByEmail_PrevAndNext(
		...
		try {
			...
			array[0] = getByEmail_PrevAndNext(
				session, student, email, orderByComparator, true);

			array[1] = student;

			array[2] = getByEmail_PrevAndNext(
				session, student, email, orderByComparator, false);
	...
	protected Student getByEmail_PrevAndNext(
		Session session, Student student, String email,
		OrderByComparator<Student> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_EMAIL_EMAIL_3 =
		"(student.email IS NULL OR student.email = '')";
	...
	public Student updateImpl(Student student) {
		...
		if (!_columnBitmaskEnabled) {
			...
			if ((studentModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					studentModelImpl.getOriginalEmail()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByEmail = new FinderPath(
			...
			new String[] {String.class.getName()},
			StudentModelImpl.EMAIL_COLUMN_BITMASK |
			StudentModelImpl.NAME_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.docs.assignment.student.model.Student"),
			true);
	}
